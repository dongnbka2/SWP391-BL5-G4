 ...
 * @author M.S.I
 */
@WebServlet(name = "ViewCategoryServlet", value = "/admin-view-category")
...
//        ArrayList<Category> list1 = CategoryDAO.getListByPage(list, begin, end);
...
////        }
        ...
        req.getRequestDispatcher("AdminPage/JSP/category.jsp").forward(req, resp);
    }
