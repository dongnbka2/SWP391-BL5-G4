...
public class ClientFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if ((url.contains("customerprofile") || url.contains("changepassword") || url.contains("codeconfirm") || url.contains("orderhistory") || url.contains("orderdetailhistory")) && acc == null) {
