                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><a href="admin-view-brand"><span class="text-muted fw-light">BRAND LIST /</span></a>
                                BRAND</h4>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card mb-4">
                                        ...
                                        <!-- Product -->
                                        <form action="update-brand" id="formAccountSettings" method="POST">
                                            <div class="card-body">
                                                <div class="d-flex align-items-start align-items-sm-center gap-4">
                                                    ...
                                                    <div class="button-wrapper">
                                                        <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                                                            ...
                                                            <input name="logo"type="file" id="upload" class="account-file-input" hidden
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <input class="form-control" type="text" id="brandCode"
                                                               name="code" value="${brand.code}" readonly/>
                                                    </div>
                                                    <div class="mb-3 col-md-6">
                                                        <label for="brandName" class="form-label">Brand Name</label>
                                                        <input class="form-control" type="text" name="name"
                                                               id="Name" value="${brand.name}" autofocus required=""/>
                                                    </div>
                                                    <input name="createdAt" type="text" style="display: none" value="${requestScope.brand.createdAt}"/>
                                                    <input name="createdBy" type="text" style="display: none" value="${requestScope.brand.createdBy}"/>
                                                    <input name="brandID" type="text" style="display: none" value="${requestScope.brand.brandID}"/>
                                                    <div class="mt-2">
