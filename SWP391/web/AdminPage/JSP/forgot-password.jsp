                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="forgot-password" method="POST">
                                <!-- Logo -->
                                <div class="justify-content-center text-center"style="margin:1%;"><h4>ENTER EMAIL</h4></div>
                                <div class="justify-content-center text-center"style="margin:1%;"><h5>Enter your email to reset your password</h5></div>
                                <!-- /Logo -->
                                <div class="mb-3">
