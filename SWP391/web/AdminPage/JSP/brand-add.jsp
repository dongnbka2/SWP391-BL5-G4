                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card mb-4">
                                        ...
                                        <!-- Product -->
                                        <form action="create-brand" id="formAccountSettings" method="POST">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <input class="form-control" type="text" name="brandName"
                                                               id="brandName" value="Doe" autofocus required/>
                                                    </div>
                                                    <div class="mb-3 col-md-6">
                                                    </div>

                                                    <div class="mt-2">
                                                        <button type="submit" class="btn btn-primary me-2">Add Brand</button>
