                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="card" style="margin: 2.5%">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <a class="card-body d-flex justify-content-end" href="create-category"><button type="button" class="btn rounded-pill btn-danger">Add Category</button></a>
                            </div>
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <c:forEach items="${list}" var="category">
                                            <tr>
                                                ...
                                                <td>
                                                    <a title="Edit" class="btn btn-sm btn-outline-primary" href="update-category?cateID=${category.cateID}">
                                ...
                                <nav aria-label="Page navigation" class="${list.size()==0?"d-none":""}">
                                    <ul class="pagination justify-content-end me-3">
                                        <li class="page-item prev">
                                            <a class="page-link" href="/SWP/admin-search-category?page=${page-1==0?size:page-1}"><i class="tf-icon bx bx-chevrons-left"></i></a>
                                        </li>
                                        <c:forEach begin="1" end="${size}" var="i">
                                            <li class="page-item ${i==page?"active":""}">
                                                <a class="page-link" href="/SWP/admin-search-category?page=${i}">${i}</a>
                                            </li>
                                        </c:forEach>
                                        <li class="page-item next">
                                            <a class="page-link" href="/SWP/admin-search-category?page=${page+1>size?1:page+1}"><i class="tf-icon bx bx-chevrons-right"></i></a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
