                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">CATEGORY LIST /</span>
                                CATEGORY</h4>
                                ...
                                <div class="col-md-12">
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="update-category" id="formAccountSettings" method="POST">
                                                <div class="row">
                                                    <div class="mb-3 col-md-6">
                                                        <label class="form-label" for="parent">Parent</label>
                                                        <select name="parentID" id="parentID" class="select2 form-select">
                                                            <c:forEach  items="${listnull}" var="listnull">
                                                                <option value="${listnull.cateID}" <c:if test="${listnull.cateID==category.parentID}">selected</c:if>>${listnull.cate}</option>
                                                            </c:forEach>
                                                            <option value="0" <c:if test="${category.parentID==0}">selected</c:if>>Other</option>
                                                        </select>
                                                    </div>
                                                    <div class="mb-3 col-md-6">
                                                        <label for="CategoryCode" class="form-label">Code</label>
                                                        <input class="form-control" type="text" id="CategoryCode"
                                                               name="code" value="${category.code}" readonly/>
                                                    </div>
                                                    <div class="mb-3 col-md-6">
                                                        <label for="cate" class="form-label">Category</label>
                                                        <input class="form-control" type="text" name="cate"
                                                               id="cate" value="${category.cate}" autofocus required/>
                                                    </div>
                                                    <input name="createdAt" type="text" style="display: none" value="${requestScope.category.createdAt}"/>
                                                    <input name="createdBy" type="text" style="display: none" value="${requestScope.category.createdBy}"/>
                                                    <input name="cateID" type="text" style="display: none" value="${requestScope.category.cateID}"/>
                                                </div>
                                                <div class="mt-2">
